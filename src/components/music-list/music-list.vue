  ...
  <div class="music-list">
    ...
    <div class="bg-image" :style="bgStyle" ref="bgImage">
      <div class="play-wrapper">
        <div class="play" @click="radom" v-show="songs.length > 0" ref="playBtn">
          <i class="icon-play"></i>
    ...
    <scroll class="list" @scroll="_scroll" :probeType="probeType" :listenScroll="listenScroll" :data="songs" ref="scroll">
...
const backdrop = addPrefix('backdrop-filter')
  ...
  watch: {
    scrollY(newY) {
      ...
      if (newY > 0) {
        ...
        blur = Math.min(20 * persent, persent)
      }
